      ...
      <div className="space-y-4">
        ...
        <div className="rounded-sm border p-4 space-y-3">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-sm font-medium">{formData.companySize || "Not set"}</span>
          </div>
          <div className="flex justify-between">
          ...
          {formData.website && (
            <div className="flex justify-between">
              ...
              <span className="text-sm font-medium truncate max-w-[200px]">{formData.website}</span>
            </div>
          )}
          <div className="flex justify-between">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-sm font-medium truncate max-w-[200px]">{formData.billingEmail || "Not set"}</span>
          </div>
          {formData.phone && (
            <div className="flex justify-between">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-sm font-medium capitalize">{formData.useCase ? formData.useCase.replace(/-/g, " ") : "Not set"}</span>
          </div>
