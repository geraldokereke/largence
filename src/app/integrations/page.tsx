                ...
                <div className="flex items-center justify-between mb-2">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Connect Largence with your favorite tools and automate your legal workflows
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-start gap-3 mb-4">
                        <div className={`p-3 rounded-sm ${integration.iconBg} shrink-0`}>
                      ...
                      {isConnected && (
                        <div className="mb-4 pb-4 border-b space-y-2">
                          ...
                          <div className="flex items-center justify-between text-xs">
                            ...
                            <span className="font-medium">{integration.syncedItems.toLocaleString()}</span>
                          </div>
                        </div>
                      )}
