...
const features = [
  {
    ...
    description: "Generate legally sound contracts in minutes with AI trained on African legal frameworks.",
    details: {
  ...
  },
  {
    ...
    description: "Stay compliant with real-time monitoring and automatic regulatory updates.",
    details: {
  ...
  },
  {
    ...
    description: "Streamline workflows with centralized document management and real-time collaboration.",
    details: {
  ...
  },
  {
    ...
    description: "Get actionable insights with comprehensive analytics on contract performance.",
    details: {
  ...
  },
  {
    ...
    description: "Bank-grade encryption and SOC 2 compliance to protect sensitive data.",
    details: {
  ...
  },
  {
    ...
    description: "Handle legal operations across multiple African countries seamlessly.",
    details: {
...
export function FeaturesSection() {
  ...
  return (
    <section id="features" className="relative py-12 md:py-16 lg:py-24 px-4 sm:px-6 touch-manipulation">
      <motion.div 
      ...
      >
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-xs sm:text-sm md:text-base lg:text-lg text-muted-foreground max-w-3xl mx-auto">
            Everything you need to manage legal workflows, compliance, and governance at enterprise scale.
          </p>
        </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="space-y-4">
                  <h3 className="font-heading text-xl font-semibold">{selectedFeature.details.heading}</h3>
                  <p className="text-muted-foreground">{selectedFeature.details.subheading}</p>
