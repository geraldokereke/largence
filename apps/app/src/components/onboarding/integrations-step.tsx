...
const availableIntegrations = [
  ...
  { id: "microsoft-365", name: "Microsoft 365", icon: FaMicrosoft, description: "Collaborate in Teams" },
  { id: "docusign", name: "DocuSign", icon: FaFileSignature, description: "E-signature integration" },
]

export function IntegrationsStep({ formData, toggleIntegration }: IntegrationsStepProps) {
  return (
    <motion.div
