...
const onboardingSteps = [
  ...
  },
  {
    ...
    description: "Specify your company size and location. This helps us provide region-specific templates and compliance frameworks.",
    features: ["Size & location", "Regional compliance"],
  },
  {
    icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z",
    title: "Team Size",
    description: "Let us know your team size to recommend the right collaboration features and workflows for your organization.",
    features: ["Team planning", "Collaboration tools"],
  },
  {
    icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4",
    title: "Use Case",
    description: "Share your primary use case so we can prioritize the right features and templates for your workflow.",
    features: ["Custom workflows", "Relevant templates"],
  },
  {
    icon: "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z",
    title: "Billing Contact",
    description: "Provide billing contact information for invoices and account management communications.",
    features: ["Secure billing", "Account management"],
  },
  {
    icon: "M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z",
    title: "Integrations",
    description: "Connect your favorite tools to streamline your legal workflow. You can always add more integrations later.",
    features: ["Tool connectivity", "Workflow automation"],
  },
  {
    icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
    title: "Review & Complete",
    description: "Review your settings and complete your workspace setup. You're almost ready to start generating compliant documents!",
    ...
    <div className="grid min-h-svh lg:grid-cols-2">
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm text-muted-foreground">{Math.round((step / 7) * 100)}% complete</span>
              </div>
            ...
            {step === 2 && (
              <CompanyDetailsStep formData={formData} updateFormData={updateFormData} />
            )}

            {step === 3 && (
              <TeamSizeStep formData={formData} updateFormData={updateFormData} />
            )}
            ...
            {step === 5 && (
              <BillingContactStep formData={formData} updateFormData={updateFormData} />
            )}

            {step === 6 && (
              <IntegrationsStep formData={formData} toggleIntegration={toggleIntegration} />
            )}
      ...
      <div className="hidden lg:flex bg-muted relative overflow-hidden">
        ...
        >
          ...
          <rect width="100%" height="100%" fill="url(#grid-pattern-onboarding)" />
        </svg>
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 max-w-2xl mx-auto">
          ...
          <div className="space-y-4 mb-12">
            <div className="flex items-start gap-3 p-4 rounded-lg bg-card/50 backdrop-blur-sm border border-border/50">
              ...
              <div>
                <p className="text-sm font-medium mb-1">Don't worry about perfection</p>
          ...
          <div className="pt-8 border-t border-border/40">
            ...
            <div className="grid grid-cols-3 gap-6">
              <div>
                <p className="text-2xl font-bold text-primary font-display mb-1">4</p>
                <p className="text-xs text-muted-foreground">Countries supported</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-primary font-display mb-1">AI</p>
                <p className="text-xs text-muted-foreground">Powered drafting</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-primary font-display mb-1">24/7</p>
